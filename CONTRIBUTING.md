# Contributing to nanomessage-rpc
...
Fork the project [on GitHub](https://github.com/geut/nanomessage-rpc) and check out your copy locally.

```bash
$ git clone git@github.com:username/nanomessage-rpc.git
$ cd nanomessage-rpc
$ npm install
$ git remote add upstream git://github.com/geut/nanomessage-rpc.git
```
